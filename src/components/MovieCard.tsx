      ...
      <div className="relative aspect-[2/3] w-full overflow-hidden bg-neutral-900">
        ...
        <div className="absolute top-2 right-2 flex flex-col gap-1 items-end z-10">
          {item.rottenTomatoesRating !== undefined ? (
            <div
              className={`px-1.5 py-0.5 rounded text-[11px] font-bold flex items-center gap-1 shadow-md backdrop-blur-md border ${
        ...
        {item.releaseYear ? (
          <div className="absolute top-2 left-2 bg-black/80 backdrop-blur-md px-2 py-0.5 rounded text-[11px] font-semibold text-zinc-300 border border-white/10 z-10">
            {item.releaseYear}
          </div>
        ) : null}
      </div>
